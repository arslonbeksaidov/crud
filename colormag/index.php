    ...
    <nav class="navbar navbar-default" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><span>Color</span>Mag</a>
        </div>
            ...
            <div class="single_stuff wow fadeInDown">
              ...
              <div class="single_stuff_article">
                <div class="single_sarticle_inner"> <a class="stuff_category" href="#"></a>
                  <div class="stuff_article_inner"> <span class="stuff_date">Nov <strong><?php echo $row["date"];?></strong></span>
                    <h2><a href="#"><?php echo $row["m_name"]; ?></a></h2>
